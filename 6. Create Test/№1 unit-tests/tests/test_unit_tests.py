#               функции по получению информации о документах, добавлении и удалении элементов из словаря.
import main
import json
import os
import unittest
...
class TestSecretaryProgram(unittest.TestCase):
    ...
    def test_get_doc_owner_name(self):
        self.assertEqual(main.get_doc_owner_name('2207 876234'), 'Василий Гупкин')
